...
const translations = {
  ...
  en: {
    ...
    section9Title: "SECTION 9 – COOKIES OR BROWSING DATA",
    ...
    // Section texts
    section1Text1:
      "This Privacy Policy contains information about the collection, use, storage, processing, and protection of personal data of users and visitors of the MOVAIMPEX.COM.BR website, with the purpose of demonstrating absolute transparency on the subject and clarifying to all interested parties the types of data that are collected, the reasons for the collection, and how users can manage or delete their personal information.",
    section1Text2:
      "This Privacy Policy applies to all users and visitors of the MOVAIMPEX.COM.BR website and is an integral part of the General Terms and Conditions of Use of the MOVAIMPEX.COM.BR website, duly registered under CNPJ no. 26.406.317/0001-16, located in AMERICANA/SP.",
    section1Text3:
      "This document was prepared in accordance with the General Personal Data Protection Law (Law 13.709/18), the Internet Civil Framework (Law 12.965/14) (and EU Regulation No. 2016/6790). Furthermore, the document may be updated due to any normative updates, which is why the user is invited to periodically consult this section.",

    section2Text1:
      "The personal data of the user and visitor are collected by the platform in the following way:",
    section2List1:
      "When the user requests our contact via a message on the MOVAIMPEX.COM.BR platform: these data are basic identification data, such as email, name, and phone number. From them, we can identify the user and visitor, in addition to ensuring greater security and well-being for their needs. Users and visitors are aware that information entered on the platform will be accessible to all other members of the MOVA IMPEX IMPORTAÇÃO E EXPORTAÇÃO LTDA team.",
    section2List2:
      "When a user and visitor accesses pages of the MOVAIMPEX.COM.BR website: information about interaction and access is collected by the company to ensure a better experience for the user and visitor. This data may cover keywords used in a search, the sharing of a specific document, comments, page views, profiles, the URL from which the user and visitor came, the browser they use, and their access IPs, among others that may be stored and retained.",

    section3Text1:
      "The personal data of the user and visitor collected are as follows:",
    section3List1:
      "Data to contact us through the MOVAIMPEX.COM.BR platform: email, name, and phone number.",
    section3List2:
    ...
    section3List3:
      "Data for completing transactions: MOVA IMPEX does not carry out or intermediate business between its users through the MOVAIMPEX.COM.BR platform, it only provides a space for its users to contact us in order to discuss questions, information, and quotes.",

    section4Text1:
      "The personal data of the user and visitor collected and stored by the MOVAIMPEX.COM.BR platform has the following purposes:",
    section4List1:
      "User and visitor well-being: to improve the service offered, facilitate, speed up and fulfill the commitments established between the user and the company, improve the user experience, and provide specific functionalities depending on the user's basic characteristics.",
    section4List2:
      "Platform improvements: to understand how the user uses the platform's services, to help in the development of business and techniques.",
    section4List3:
      "Commercial: the data is used to personalize the content offered and provide support to the platform to improve the quality of service functioning.",
    section4List4:
      "User profile prediction: automated processing of personal data to evaluate platform usage. The processing of personal data for purposes not provided for in this Privacy Policy will only occur with prior communication to the user, so that the rights and obligations provided herein remain applicable.",

    section5Text1:
      "The personal data of the user and visitor are stored by the platform for the period necessary to provide the service or fulfill the purposes provided for in this document, as provided for in item I of article 15 of Law 13.709/18.",
    section5Text2:
      "The data can be removed or anonymized at the user's request, except in cases where the law offers other treatment.",
    section5Text3:
      "Furthermore, the personal data of users can only be kept after the end of its processing in the following cases provided for in article 16 of the aforementioned law:",
    section5List1:
    ...
    section5List4:
      "IV – Exclusive use by the controller, its access by a third party being prohibited, and provided that the data are anonymized.",

    section6Text1:
      "The platform undertakes to apply technical and organizational measures capable of protecting personal data from unauthorized access and from situations of destruction, loss, alteration, communication, or diffusion of such data.",
    section6Text2:
      "The platform does not exempt itself from responsibility for the exclusive fault of third parties, such as in the case of a hacker or cracker attack, or the exclusive fault of the user, such as in the case where the user transfers their data to third parties. The website undertakes to notify the user in the event of any security breach of their personal data.",
    section6Text3:
    ...
    section7Text1:
      "The user's data is only shared with data related to publications made by the user themselves; such actions are publicly shared with all members of the MOVA IMPEX IMPORTAÇÃO E EXPORTAÇÃO LTDA team.",
    section7Text2:
      "The user's profile data is shared publicly in search systems and within the platform, and the user is allowed to modify this setting so that their profile does not appear in the search results of such tools.",

    section8Text1:
      "Personal data will not be shared with third parties, therefore, if the user accesses any advertisement belonging to another website, all responsibility for the said data protection of that user is transferred to the new website accessed. By being redirected to a third-party application or website, you will no longer be governed by this Privacy Policy or our platform's Terms of Service. We are not responsible for the privacy practices of other websites and we encourage you to read their privacy statements.",

    section9Text1:
      "Cookies refer to text files sent by the platform to the user's and visitor's computer and which are stored there, containing information related to browsing the website. Such information is related to access data such as location and time of access and is stored by the user's and visitor's browser so that the platform's server can read it later in order to personalize the platform's services. The user and visitor of the MOVAIMPEX.COM.BR platform state that they know and accept that a system for collecting browsing data can be used through the use of cookies.",
    section9Text2:
    ...
    section9Text3:
      "The session cookie is temporary and disappears after the browser is closed. It is possible to reset your web browser to refuse all cookies, but some features of the platform may not function correctly if the ability to accept cookies is disabled.",

    section10Text1:
      "By using the services and providing personal information on the MOVAIMPEX.COM.BR platform, you are consenting to this Privacy Policy. The user has the right to withdraw their consent at any time, for which they must contact us via the email contato@movaimpex.com.br",
    ...
    section11Text2:
      "Changes and clarifications will take effect immediately after their publication on the platform. When changes are made, the modification date reported in the first line of this current term will be updated. By using the service or providing personal information after any modifications, the user and visitor demonstrates their agreement with the new rules. In the event of the platform being merged with or sold to another company, user data may be transferred to the new owners so that the services offered can be continued.",

    section12Text1:
      "For the resolution of disputes arising from this instrument, Brazilian law will be fully applied. Any disputes must be brought before the court of the district in which the company's headquarters are located.",
  },
};
